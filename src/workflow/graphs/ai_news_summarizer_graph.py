...
class AINewsSummarizerGraph:
    def __init__(self, model):
        self.model = model
        self.graph = StateGraph(AINewsSummarizerState)
    ...
    def build_graph(self):
        ...
        # add nodes
        self.graph.add_node("fetch_ai_news", "")
        self.graph.add_node("summarize_ai_news", "")
        self.graph.add_node("save_ai_results", "")

        # add edges
        self.graph.set_entry_point("fetch_ai_news")
        self.graph.add_edge("fetch_ai_news", "summarize_ai_ news")
